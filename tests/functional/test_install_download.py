...
from pip.download import _get_response_from_url as _get_response_from_url_original, get_file_content, path_to_url2, unpack_http_url, URLOpener
from pip.index import Link
from tests.lib import reset_env, run_pip, write_file, tests_data, pyversion
